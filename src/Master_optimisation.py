...
# Break into codons
compared_codons = []
for orig1, opt2 in zip(new_seq, old_seq):
...
for i, x in zip(flattened, identical_nucs):
...
for i in identical_nucs:
    i.to_csv(f'{new_output_folder}codons_name.csv')
